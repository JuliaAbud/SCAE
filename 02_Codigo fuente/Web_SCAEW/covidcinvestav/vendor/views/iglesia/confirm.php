...
<div id="cabezal" style="background-color:#e5e5e5;padding:15px;text-align:center;">
...
<div id="responsive-form" class="clearfix" style=text-align:center>
    ...
    <div class="form-row">
        ...
        <div class="column-full"><h2> Datos del pastor</h2></div>
    ...
    'options' => ['class' => 'form-control'],
        ...
        <div class="column-full"><h2>Datos de la Iglesia</h2></div>
 ...
 <?= $form->field($model, 'idpresbiterio')->DropDownList(
     ...
     <div class="column-full"><h2>Domicilio de la casa pastoral</h2></div>
        <div class="column-half">
